...
<?php $form = ActiveForm::begin([
    ...
    'fieldConfig' => [
        'template' => "{label}\n{input}\n{error}",
        'labelOptions' => ['class' => 'col-lg-10 col-form-label mr-lg-1'],
                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center py-">
                            <div class="card-body p-4 p-lg-5 text-black ">
                                <form>
                                    ...
                                    <h2 class="fw-normal mb-3" style="letter-spacing: 1px;">Sign Up into your account</h2>

                                    <div class="form-outline">
                                        <?= $form->field($model, 'username')->textInput(['autofocus' => true, 'style' => 'font-size: 16px; height: 40px;'])->label('Username', ['class' => '']) ?>
                                    </div>

                                    <div class="form-outline">
                                        <?= $form->field($model, 'password')->passwordInput(['style' => 'font-size: 16px; height: 40px;'])->label('Password', ['class' => 'mb-1 !important']) ?>
                                    </div>

                                    <div class="form-outline">
                                        <?= $form->field($model, 'password_repeat')->passwordInput(['style' => 'font-size: 16px; height: 40px;'])->label('Password Repeat', ['class' => '']) ?>
                                    </div>
                                    ...
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Already have an account? <a href="/site/login"
